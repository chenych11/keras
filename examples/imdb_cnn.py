...
model.fit(X_train, y_train, callbacks=History(), show_metrics=('loss', 'acc'), batch_size=128, nb_epoch=10, verbose=1,
...
# ==========================================================================
print('Build model...LookupTable')
model = Sequential()

# we start off with an efficient embedding layer which maps
# our vocab indices into embedding_dims dimensions
model.add(LookupTable(max_features, embedding_dims))
model.add(Dropout(0.25))
